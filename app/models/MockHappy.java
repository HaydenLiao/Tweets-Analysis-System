 ...
 *
 */
public class MockHappy implements Twitter,TwitterApiInstance{

	private static MockHappy mockHappy;
	@Override
	public Twitter geTwitterInstance() {
		if(mockHappy ==null) {
			mockHappy = new MockHappy();
		}
		return mockHappy;
	}
	@Override
	...
	public ResponseList<Status> getUserTimeline(String arg0, Paging arg1) throws TwitterException {
		...
		ResponseList<Status> result = new ResponseList<Status>() {
